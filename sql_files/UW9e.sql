...
BEGIN
  ...
  BEGIN
    ...
    SELECT id INTO v_org_id FROM public.organizations WHERE name = NEW.organization_name LIMIT 1;

    -- 4. If not found, Create it!
    IF v_org_id IS NULL THEN
      INSERT INTO public.organizations (name, slug, type, status, created_by)
      VALUES (
