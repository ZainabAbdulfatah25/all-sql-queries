-- ============================================================================
-- FIX SCHEMA SUPER NUCLEAR V2 (NO INVALID COLUMN REFS)
-- Purpose: 
-- 1. Dynamically find and drop ALL policies.
-- 2. Alter column types to TEXT.
-- 3. Recreate Policies and Update Data (Cases Only).
-- ============================================================================
...
-- F. UPDATE DATA (Cases Only)
-- Removed the failing registration update since the column name is uncertain.
UPDATE cases 
...
DO $$
BEGIN
  RAISE NOTICE 'Schema cleanup complete. Core issue resolved.';
END $$;
