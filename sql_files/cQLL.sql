...
BEGIN
  ...
  IF v_current_user_role IN ('admin', 'super_admin', 'state_admin') THEN
    ...
    INSERT INTO users (id, email, name, role, phone, department, organization_name, organization_type, organization_id, user_type)
    VALUES (p_id, p_email, p_name, p_role, p_phone, p_department, p_organization_name, p_organization_type, p_organization_id, p_user_type)
  ...
  ELSIF v_current_user_role IN ('organization', 'manager') THEN 
    ...
    INSERT INTO users (id, email, name, role, phone, department, organization_name, organization_type, organization_id, user_type)
    VALUES (p_id, p_email, p_name, p_role, p_phone, p_department, v_org_name, p_organization_type, v_org_id, p_user_type)
    RETURNING * INTO v_new_user;
